...
public class Taxi_Menu extends RelativeLayout {
	...
	public Taxi_Menu(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public Taxi_Menu(Context context) {
		super(context);
	}
...
//		});
	...
	protected void onLayout(boolean changed, int left, int top, int right,
		...
		menu.layout(menuRightMargin, top, right, bottom);
