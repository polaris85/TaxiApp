...
public class CircularProgressBar extends View
{
    ...
    protected void onDraw(final Canvas canvas)
    {
        ...
        canvas.drawArc(this.mArcBounds, CircularProgressBar.ADJUST_FOR_12_OCLOCK,- ( 360 - sweepAngle.floatValue()), false, this.mProgressPaint);
        ...
        if (this.mShowText)
        {
            ...
            canvas.drawText(String.valueOf(60 - this.mProgress), center, center + (this.mTextBounds.height() >> 1),
                            this.mTextPaint);
        }
    }
